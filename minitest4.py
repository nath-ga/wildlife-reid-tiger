...
def zeige_mehrere_paare(mit_label=1, anzahl=3):
    gefunden = 0
...
zeige_mehrere_paare(mit_label=1, anzahl=2)  # Zwei ähnliche Paare
zeige_mehrere_paare(mit_label=0, anzahl=2)  # Zwei unterschiedliche Paare
